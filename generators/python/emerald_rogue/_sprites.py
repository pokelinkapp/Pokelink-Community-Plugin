...
def _process_item_sprites(item_dir: str):
    ...
    output = directories.get_output_dir("emerald_rogue/assets/items", True)
...
def _process_pokemon_sprites(pokemon_dir: str):
    ...
    output = directories.get_output_dir("emerald_rogue/assets/pokemon", True)
    directories.get_output_dir("emerald_rogue/assets/pokemon/party", True)
    directories.get_output_dir("emerald_rogue/assets/pokemon/normal", True)
    directories.get_output_dir("emerald_rogue/assets/pokemon/shiny", True)
