        ...
        if not is_icon and not is_female_sprite:
            if output_name == "dusknoir-mega":
                ...
                target_palette = os.path.join(sprite_dir.path,
                    ...
                    "alcremie-") and not output_name.endswith("gmax"):
                target_palette = os.path.join(sprite_dir.path, (
                    output_name.removeprefix(
                        "alcremie-") if not output_name.endswith(
                        "vanilla_cream") else f"{sprite_dir.name}_default") + ".pal")
